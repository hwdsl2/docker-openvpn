...
- [ ] I searched existing [Issues](https://github.com/hwdsl2/docker-openvpn/issues?q=is%3Aissue), and did not find a similar enhancement request
- [ ] I read the [README](https://github.com/hwdsl2/docker-openvpn/blob/main/README.md) or the relevant section
- [ ] This request is about the OpenVPN Docker image/config
